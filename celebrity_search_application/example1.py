...
input_text=st.text_input("Write the name of the celebrity you want to search")
...
second_input_prompt=PromptTemplate(input_variables=['person'], template="In which year was {person} born?")
